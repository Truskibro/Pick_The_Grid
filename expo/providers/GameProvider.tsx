...
export const [GameProvider, useGame] = createContextHook(() => {
  ...
  const loadFromSupabase = useCallback(async () => {
    ...
    try {
      ...
      // Backfill missing username/displayName from the local profile.
                ...
                .upsert(
                  {
                    ...
                    display_name: myDisplayName || localProfileRef.current.displayName,
  ...
  const loadFromLocal = useCallback(async () => {
    try {
      ...
      if (predData) {
        ...
        // Backfill missing username/displayName from the local profile so predictions
