...
export const SEED_PREDICTIONS: Record<string, Record<string, RawPrediction>> = {
  ...
  'cb7536a7-ad8b-44d4-981b-4b24c19abcc4': {
    ...
    r09: {
      raceId: 'r09',
      top10: ['ANT', 'HAM', 'LEC', 'RUS', 'VER', 'NOR', 'HAD', 'PIA', 'LAW', 'GAS'],
      fastestLap: 'ANT',
      dnf: 'LIN',
      pointsEarned: 0,
      sprintTop8: ['ANT', 'HAM', 'LEC', 'RUS', 'VER', 'NOR', 'PIA', 'HAD'],
      sprintPointsEarned: 0,
    },
    r10: {
      raceId: 'r10',
      top10: ['ANT', 'RUS', 'LEC', 'HAM', 'VER', 'PIA', 'NOR', 'LIN', 'BOR', 'GAS'],
      fastestLap: 'ANT',
      dnf: 'LAW',
      pointsEarned: 0,
      sprintTop8: [],
  ...
  '652154af-dc27-47b5-aa79-25903b9c4a1b': {
    ...
    r07: {
      raceId: 'r07',
      top10: ['HAM', 'ANT', 'RUS', 'VER', 'NOR', 'PIA', 'HAD', 'LEC', 'HUL', 'LAW'],
      fastestLap: 'ANT',
      dnf: 'ALO',
      pointsEarned: 0,
      sprintTop8: [],
    ...
    r08: {
      raceId: 'r08',
      top10: ['HAM', 'LEC', 'RUS', 'ANT', 'VER', 'NOR', 'PIA', 'LAW', 'GAS', 'HAD'],
      fastestLap: 'LEC',
      dnf: 'STR',
      pointsEarned: 0,
      sprintTop8: [],
    ...
    r09: {
      raceId: 'r09',
      top10: ['ANT', 'HAM', 'RUS', 'LEC', 'NOR', 'VER', 'PIA', 'HAD', 'LAW', 'LIN'],
      fastestLap: 'ANT',
      dnf: 'STR',
      pointsEarned: 0,
      sprintTop8: ['HAM', 'ANT', 'VER', 'LEC', 'RUS', 'NOR', 'PIA', 'HAD'],
      sprintPointsEarned: 0,
    },
    r10: {
      raceId: 'r10',
      top10: ['ANT', 'RUS', 'VER', 'LEC', 'HAM', 'PIA', 'NOR', 'LIN', 'BOR', 'GAS'],
      fastestLap: 'ANT',
      dnf: 'PER',
      pointsEarned: 0,
      sprintTop8: [],
  ...
  'f35417e9-4f0d-4def-9c2f-c81276863fc0': {
    ...
    r07: {
      raceId: 'r07',
      top10: ['RUS', 'ANT', 'HAM', 'NOR', 'VER', 'PIA', 'LEC', 'HAD', 'LAW', 'SAI'],
      fastestLap: 'ANT',
      dnf: null,
      pointsEarned: 0,
      sprintTop8: [],
    ...
    r08: {
      raceId: 'r08',
      top10: ['ANT', 'HAM', 'RUS', 'LEC', 'VER', 'NOR', 'PIA', 'HAD', 'LAW', 'GAS'],
      fastestLap: 'ANT',
      dnf: 'BOT',
      pointsEarned: 0,
      sprintTop8: [],
    ...
    r09: {
      raceId: 'r09',
      top10: ['ANT', 'RUS', 'HAM', 'LEC', 'VER', 'NOR', 'PIA', 'HAD', 'LAW', 'GAS'],
      fastestLap: 'ANT',
      dnf: 'STR',
      pointsEarned: 0,
      sprintTop8: ['ANT', 'HAM', 'VER', 'LEC', 'RUS', 'NOR', 'PIA', 'HAD'],
      sprintPointsEarned: 0,
    },
    r10: {
      raceId: 'r10',
      top10: ['ANT', 'RUS', 'VER', 'LEC', 'HAM', 'PIA', 'NOR', 'LAW', 'GAS', 'LIN'],
      fastestLap: 'ANT',
      dnf: 'STR',
      pointsEarned: 0,
      sprintTop8: [],
  ...
  'e11ea4f5-2ba4-4241-9791-b4b6a560534b': {
    ...
    r08: {
      raceId: 'r08',
      top10: ['RUS', 'ANT', 'HAM', 'LEC', 'NOR', 'VER', 'PIA', 'HAD', 'LAW', 'GAS'],
      fastestLap: 'ANT',
      dnf: 'ALO',
      pointsEarned: 0,
      sprintTop8: [],
    ...
    r09: {
      raceId: 'r09',
      top10: ['ANT', 'HAM', 'RUS', 'LEC', 'VER', 'NOR', 'HAD', 'PIA', 'LIN', 'LAW'],
      fastestLap: 'ANT',
      dnf: 'STR',
      pointsEarned: 0,
      sprintTop8: ['HAM', 'ANT', 'VER', 'RUS', 'LEC', 'NOR', 'PIA', 'LAW'],
      sprintPointsEarned: 0,
    },
    r10: {
      raceId: 'r10',
      top10: ['ANT', 'RUS', 'LEC', 'VER', 'HAM', 'PIA', 'NOR', 'LAW', 'COL', 'GAS'],
      fastestLap: 'ANT',
      dnf: 'STR',
      pointsEarned: 0,
      sprintTop8: [],
