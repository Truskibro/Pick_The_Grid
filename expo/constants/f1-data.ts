...
export const DRIVERS: Driver[] = [
  ...
  { id: 'ALB', name: 'Alex Albon', shortName: 'ALB', number: 23, teamId: 'williams', championshipPoints: 1 },
  { id: 'OCO', name: 'Esteban Ocon', shortName: 'OCO', number: 31, teamId: 'haas', championshipPoints: 1 },
...
export const MOCK_RACE_RESULTS: RaceResult[] = [
  ...
  },
  {
    raceId: 'r08',
    classification: [
      { position: 1,  driverId: 'ANT', time: '2:23:31.243', gap: 'Leader',   points: 25, status: 'finished' as const },
      { position: 2,  driverId: 'HAM', time: '2:23:37.514', gap: '+6.271s',   points: 18, status: 'finished' as const },
      { position: 3,  driverId: 'GAS', time: '2:23:51.612', gap: '+20.369s',  points: 15, status: 'finished' as const },
      { position: 4,  driverId: 'HAD', time: '2:23:54.637', gap: '+23.394s',  points: 12, status: 'finished' as const },
      { position: 5,  driverId: 'PIA', time: '2:23:55.504', gap: '+24.261s',  points: 10, status: 'finished' as const },
      { position: 6,  driverId: 'LAW', time: '2:23:57.796', gap: '+26.553s',  points: 8,  status: 'finished' as const },
      { position: 7,  driverId: 'LIN', time: '2:24:00.253', gap: '+29.010s',  points: 6,  status: 'finished' as const },
      { position: 8,  driverId: 'ALB', time: '2:24:04.656', gap: '+33.413s',  points: 4,  status: 'finished' as const },
      { position: 9,  driverId: 'OCO', time: '2:24:08.383', gap: '+37.140s',  points: 2,  status: 'finished' as const },
      { position: 10, driverId: 'ALO', time: '2:24:13.142', gap: '+41.899s',  points: 1,  status: 'finished' as const },
      { position: 11, driverId: 'BOR', time: '2:24:13.991', gap: '+42.748s',  points: 0,  status: 'finished' as const },
      { position: 12, driverId: 'RUS', time: '2:24:14.596', gap: '+43.353s',  points: 0,  status: 'finished' as const },
      { position: 13, driverId: 'HUL', time: '2:24:15.345', gap: '+44.102s',  points: 0,  status: 'finished' as const },
      { position: 14, driverId: 'COL', time: '2:24:20.207', gap: '+48.964s',  points: 0,  status: 'finished' as const },
      { position: 15, driverId: 'PER', time: '2:24:20.396', gap: '+49.153s',  points: 0,  status: 'finished' as const },
  ...
  },
  {
    raceId: 'r09',
    classification: [
      { position: 1,  driverId: 'HAM', time: '1:32:28.105', gap: 'Leader',   points: 25, status: 'finished' as const },
      { position: 2,  driverId: 'RUS', time: '1:32:47.666', gap: '+19.561s',  points: 18, status: 'finished' as const },
      { position: 3,  driverId: 'NOR', time: '1:32:51.824', gap: '+23.719s',  points: 15, status: 'finished' as const },
      { position: 4,  driverId: 'VER', time: '1:33:08.602', gap: '+40.497s',  points: 12, status: 'finished' as const },
      { position: 5,  driverId: 'PIA', time: '1:33:26.766', gap: '+58.661s',  points: 10, status: 'finished' as const },
      { position: 6,  driverId: 'HAD', time: '1:33:52.732', gap: '+1 lap',    points: 8,  status: 'finished' as const },
      { position: 7,  driverId: 'GAS', time: '1:34:23.894', gap: '+1 lap',    points: 6,  status: 'finished' as const },
      { position: 8,  driverId: 'LAW', time: '1:34:40.329', gap: '+1 lap',    points: 4,  status: 'finished' as const },
      { position: 9,  driverId: 'LIN', time: '1:34:46.179', gap: '+1 lap',    points: 2,  status: 'finished' as const },
      { position: 10, driverId: 'COL', time: '1:34:47.972', gap: '+1 lap',    points: 1,  status: 'finished' as const },
      { position: 11, driverId: 'BOR', time: '1:34:54.792', gap: '+1 lap',    points: 0,  status: 'finished' as const },
      { position: 12, driverId: 'SAI', time: '1:34:55.971', gap: '+1 lap',    points: 0,  status: 'finished' as const },
      { position: 13, driverId: 'OCO', time: '1:35:27.254', gap: '+1 lap',    points: 0,  status: 'finished' as const },
      { position: 14, driverId: 'PER', time: '1:35:35.874', gap: '+1 lap',    points: 0,  status: 'finished' as const },
      ...
      { position: 18, driverId: 'ALB', time: '1:34:--',     gap: '+1 lap',    points: 0,  status: 'finished' as const },
