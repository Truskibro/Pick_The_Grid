...
export const MOCK_RACE_RESULTS: RaceResult[] = [
  ...
  },
  {
    raceId: 'r08',
    classification: [
      { position: 1,  driverId: 'ANT', time: '1:42:18.903', gap: 'Leader',   points: 25, status: 'finished' as const },
      { position: 2,  driverId: 'VER', time: '1:42:25.174', gap: '+6.271s',   points: 18, status: 'finished' as const },
      { position: 3,  driverId: 'HAM', time: '1:42:42.497', gap: '+23.594s',  points: 15, status: 'finished' as const },
      { position: 4,  driverId: 'LEC', time: '1:42:43.364', gap: '+24.461s',  points: 12, status: 'finished' as const },
      { position: 5,  driverId: 'HAD', time: '1:42:45.656', gap: '+26.753s',  points: 10, status: 'finished' as const },
      { position: 6,  driverId: 'RUS', time: '1:42:46.113', gap: '+27.210s',  points: 8,  status: 'finished' as const },
      { position: 7,  driverId: 'PIA', time: '1:42:47.472', gap: '+28.569s',  points: 6,  status: 'finished' as const },
      { position: 8,  driverId: 'NOR', time: '1:42:50.516', gap: '+31.613s',  points: 4,  status: 'finished' as const },
      { position: 9,  driverId: 'GAS', time: '1:42:54.243', gap: '+35.340s',  points: 2,  status: 'finished' as const },
      { position: 10, driverId: 'LAW', time: '1:42:56.256', gap: '+37.353s',  points: 1,  status: 'finished' as const },
      { position: 11, driverId: 'ALB', time: '1:42:59.002', gap: '+40.099s',  points: 0,  status: 'finished' as const },
      { position: 12, driverId: 'SAI', time: '1:42:59.851', gap: '+40.948s',  points: 0,  status: 'finished' as const },
      { position: 13, driverId: 'HUL', time: '1:43:00.456', gap: '+41.553s',  points: 0,  status: 'finished' as const },
      { position: 14, driverId: 'COL', time: '1:43:01.205', gap: '+42.302s',  points: 0,  status: 'finished' as const },
      { position: 15, driverId: 'LIN', time: '1:43:06.067', gap: '+47.164s',  points: 0,  status: 'finished' as const },
      { position: 16, driverId: 'BOR', time: '1:43:07.891', gap: '+48.988s',  points: 0,  status: 'finished' as const },
      { position: 17, driverId: 'OCO', time: '1:43:09.234', gap: '+50.331s',  points: 0,  status: 'finished' as const },
      { position: 18, driverId: 'PER', time: '1:43:10.567', gap: '+51.664s',  points: 0,  status: 'finished' as const },
      { position: 19, driverId: 'BEA', time: '1:43:14.123', gap: '+55.220s',  points: 0,  status: 'finished' as const },
      { position: 20, driverId: 'BOT', time: '1:43:18.456', gap: '+59.553s',  points: 0,  status: 'finished' as const },
