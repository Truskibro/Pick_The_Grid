...
export const MOCK_RACE_RESULTS: RaceResult[] = [
  ...
  // ── r02: Chinese GP (2026-03-15) — Sprint + GP ──
  {
    ...
    classification: [
      ...
      { position: 19, driverId: 'PIA', time: '',             gap: 'DNS',       points: 0,  status: 'dnf' as const },
      { position: 20, driverId: 'NOR', time: '',             gap: 'DNS',       points: 0,  status: 'dnf' as const },
      { position: 21, driverId: 'BOR', time: '',             gap: 'DNS',       points: 0,  status: 'dnf' as const },
      { position: 22, driverId: 'ALB', time: '',             gap: 'DNS',       points: 0,  status: 'dnf' as const },
    ],
    fastestLapDriverId: 'ANT',
