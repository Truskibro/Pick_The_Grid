...
export const MOCK_RACE_RESULTS: RaceResult[] = [
  ...
  },
  {
    raceId: 'r08',
    classification: [
      { position: 1,  driverId: 'ANT', time: '1:41:57.103', gap: 'Leader',   points: 25, status: 'finished' as const },
      { position: 2,  driverId: 'HAM', time: '1:42:03.374', gap: '+6.271s',   points: 18, status: 'finished' as const },
      { position: 3,  driverId: 'HAD', time: '1:42:20.497', gap: '+23.394s',  points: 15, status: 'finished' as const },
      { position: 4,  driverId: 'PIA', time: '1:42:21.364', gap: '+24.261s',  points: 12, status: 'finished' as const },
      { position: 5,  driverId: 'LAW', time: '1:42:23.656', gap: '+26.553s',  points: 10, status: 'finished' as const },
      { position: 6,  driverId: 'LIN', time: '1:42:26.113', gap: '+29.010s',  points: 8,  status: 'finished' as const },
      { position: 7,  driverId: 'GAS', time: '1:42:27.472', gap: '+30.369s',  points: 6,  status: 'finished' as const },
      { position: 8,  driverId: 'ALB', time: '1:42:30.516', gap: '+33.413s',  points: 4,  status: 'finished' as const },
      { position: 9,  driverId: 'OCO', time: '1:42:34.243', gap: '+37.140s',  points: 2,  status: 'finished' as const },
      { position: 10, driverId: 'PER', time: '1:42:36.256', gap: '+39.153s',  points: 1,  status: 'finished' as const },
      { position: 11, driverId: 'ALO', time: '1:42:39.002', gap: '+41.899s',  points: 0,  status: 'finished' as const },
      { position: 12, driverId: 'BOR', time: '1:42:39.851', gap: '+42.748s',  points: 0,  status: 'finished' as const },
      { position: 13, driverId: 'RUS', time: '1:42:40.456', gap: '+43.353s',  points: 0,  status: 'finished' as const },
      { position: 14, driverId: 'HUL', time: '1:42:41.205', gap: '+44.102s',  points: 0,  status: 'finished' as const },
      { position: 15, driverId: 'COL', time: '1:42:46.067', gap: '+48.964s',  points: 0,  status: 'finished' as const },
